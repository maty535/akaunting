...
class Company extends Eloquent
{
    ...
    protected $fillable = ['domain', 'enabled', 'phone',  'iban', 'bic', 'number', 'tax_number',];
     ...
     * @var array
     */
    public $sortable = ['name', 'domain', 'email', 'phone', 'iban', 'bic', 'number', 'tax_number','enabled', 'created_at'];
