                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                {{ $item->taxUsedAsString }} %
                                </td>
                                <td
                                class="text-right">@money($item->totalTaxAmount, $invoice->currency_code, true)</td>
                                
                                
                                @stack('taxes_td_end')
                                @stack('total_td_start')
                                <td class="text-right">@money($item->total + $item->totalTaxAmount, $invoice->currency_code, true)</td>
                                @stack('total_td_end')
                            </tr>
                            @endforeach
                        </tbody>
